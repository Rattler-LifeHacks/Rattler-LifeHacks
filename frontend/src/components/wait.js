...
import "./WaitTimes.css"; // Create this CSS file for flipping animations.
...
const WaitTimes = () => {
    ...
    const [flippedCard, setFlippedCard] = useState(null); // Track the flipped tile
                            ...
                            <div className="card-back">
                                {isLoaded ? (
                                    <GoogleMap
                                        ...
                                        center={{ lat: getCoordinatesForLocation(wt.locationId).latitude, lng: getCoordinatesForLocation(wt.locationId).longitude }}
                                        zoom={15}
                                    >
                                    </GoogleMap>
